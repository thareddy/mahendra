...
print("Accuracy on training set: {:.3f}".format(logreg_classifier.score(X_train, y_train)))
print("Accuracy on test set: {:.3f}".format(logreg_classifier.score(X_test, y_test)))


# # Predicting the Test set results
y_pred_class_logclf = logreg_classifier.predict(X_test)
y_pred_prob_logclf = logreg_classifier.predict_proba(X_test)

print('accuracy of y predict is {:.3f}'.format(accuracy_score(y_test,y_pred_class_logclf)))
print('roc-auc of y proba is {:.3f}'.format(roc_auc_score(y_test,y_pred_prob_logclf[:,1])))
...
plot_roc(y_test, y_pred_prob_logclf[:, 1], 'RF')
plt.show()
...
cm = confusion_matrix(y_test, y_pred_class_logclf)
...
round(roc_auc_score(y_test,y_pred_class_logclf),5)